...
## Environments
- Preview: https://main--itc-bingosnacks--aemysites.aem.page/
- Live: https://main--itc-bingosnacks--aemysites.aem.live/
- Block Library: https://main--itc-bingosnacks--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-bingosnacks` directory in your favorite IDE and start coding :)
